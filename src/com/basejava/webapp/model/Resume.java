...
public class Resume implements Comparable<Resume>, Serializable {
    ...
    static {
        ...
        EMPTY.setSection(SectionType.EXPERIENCE, new InstitutionSection(Institution.EMPTY));
        EMPTY.setSection(SectionType.EDUCATION, new InstitutionSection(Institution.EMPTY));
    }
